        ...
        <section className="py-32 px-6 bg-cream text-emerald-950">
             <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div className="order-2 md:order-1">
                    ...
                    <button className="bg-emerald-900 text-gold-100 px-8 py-3 uppercase text-xs tracking-widest hover:bg-emerald-800">
                        Explore The Taproom
                    </button>
                </div>
                <div className="order-1 md:order-2">
                     <img src="https://images.unsplash.com/photo-1574096079513-d8259312b785?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" className="w-full h-[600px] object-cover grayscale hover:grayscale-0 transition-all duration-500" alt="Taproom" />
                </div>
             </div>
        </section>
      </main>
